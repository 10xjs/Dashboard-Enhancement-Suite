...
function initExtension(){
    $(document).ready(function () {
        ...
        function getTimeDifference() {
            var loggedTime = $('#ctl00_plcContentPlaceHolder_lblTotalTime').text(),
            loggedHours = parseInt(loggedTime.match(/([0-9]+)h/) || 0, 10),
            loggedMinutes = parseInt(loggedTime.match(/([0-9]+)m/) || 0, 0),
